...
`r2_v5_02_09-2.urdf` を RViz に表示し、`trajectory_msgs/msg/JointTrajectory` を受信して `/joint_states` を配信する ROS2 パッケージです。
...
joint_names: ['Revolute 1_1', 'Slider 1_2', 'Slider 1_3', 'Revolute 1_4', 'Revolute 2_1', 'Revolute 2_2']
points:
- positions: [0.05, 0.1, 0.0, 0.2, 0.0, 0.0]
