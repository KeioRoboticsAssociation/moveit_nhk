...
stm32_mavlink_msgs__msg__RS485ReadResponse__create()
{
  ...
  stm32_mavlink_msgs__msg__RS485ReadResponse * msg = (stm32_mavlink_msgs__msg__RS485ReadResponse *)allocator.allocate(sizeof(stm32_mavlink_msgs__msg__RS485ReadResponse), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stm32_mavlink_msgs__msg__RS485ReadResponse));
  bool success = stm32_mavlink_msgs__msg__RS485ReadResponse__init(msg);
  if (!success) {
...
stm32_mavlink_msgs__msg__RS485ReadResponse__destroy(stm32_mavlink_msgs__msg__RS485ReadResponse * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    stm32_mavlink_msgs__msg__RS485ReadResponse__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence__init(stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm32_mavlink_msgs__msg__RS485ReadResponse * data = NULL;

  if (size) {
    data = (stm32_mavlink_msgs__msg__RS485ReadResponse *)allocator.zero_allocate(size, sizeof(stm32_mavlink_msgs__msg__RS485ReadResponse), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stm32_mavlink_msgs__msg__RS485ReadResponse__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        stm32_mavlink_msgs__msg__RS485ReadResponse__fini(&data[i - 1]);
      }
...
stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence__fini(stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      stm32_mavlink_msgs__msg__RS485ReadResponse__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence * array = (stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence *)allocator.allocate(sizeof(stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence__init(array, size);
  if (!success) {
...
stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence__destroy(stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence__are_equal(const stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence * lhs, const stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stm32_mavlink_msgs__msg__RS485ReadResponse__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stm32_mavlink_msgs__msg__RS485ReadResponse__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stm32_mavlink_msgs__msg__RS485ReadResponse);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stm32_mavlink_msgs__msg__RS485ReadResponse * data =
      (stm32_mavlink_msgs__msg__RS485ReadResponse *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stm32_mavlink_msgs__msg__RS485ReadResponse__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stm32_mavlink_msgs__msg__RS485ReadResponse__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!stm32_mavlink_msgs__msg__RS485ReadResponse__copy(
