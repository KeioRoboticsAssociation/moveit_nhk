...
#ifndef STM32_MAVLINK_MSGS__MSG__DETAIL__SERVO_STATE__TRAITS_HPP_
#define STM32_MAVLINK_MSGS__MSG__DETAIL__SERVO_STATE__TRAITS_HPP_
...
inline void to_yaml(
  const stm32_mavlink_msgs::msg::ServoState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const stm32_mavlink_msgs::msg::ServoState & msg)
{
  return stm32_mavlink_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<stm32_mavlink_msgs::msg::ServoState>()
{
  return "stm32_mavlink_msgs::msg::ServoState";
}

template<>
inline const char * name<stm32_mavlink_msgs::msg::ServoState>()
{
  return "stm32_mavlink_msgs/msg/ServoState";
}

template<>
struct has_fixed_size<stm32_mavlink_msgs::msg::ServoState>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<stm32_mavlink_msgs::msg::ServoState>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<stm32_mavlink_msgs::msg::ServoState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // STM32_MAVLINK_MSGS__MSG__DETAIL__SERVO_STATE__TRAITS_HPP_
