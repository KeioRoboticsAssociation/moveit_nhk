...
bool stm32_mavlink_msgs__msg__rs485_read_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("stm32_mavlink_msgs.msg._rs485_read_response.RS485ReadResponse", full_classname_dest, 61) == 0);
  }
  stm32_mavlink_msgs__msg__RS485ReadResponse * ros_message = _ros_message;
  {  // motor_id
...
{
  /* NOTE(esteve): Call constructor of RS485ReadResponse */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("stm32_mavlink_msgs.msg._rs485_read_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RS485ReadResponse");
