#pragma message("#include \"trac_ik_kinematics_plugin_parameters.hpp\" is deprecated. Use #include <trac_ik_kinematics_plugin/trac_ik_kinematics_plugin_parameters.hpp> instead.")
  ...
  public:
    ...
    rcl_interfaces::msg::SetParametersResult update(const std::vector<rclcpp::Parameter> &parameters) {
      ...
      for (const auto &param: parameters) {
        ...
        if (param.get_name() == (prefix_ + "solve_type")) {
            if(auto validation_result = one_of<std::string>(param, {"Speed", "Distance", "Manipulation1", "Manipulation2", "Manipulation3"});
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "solve_type")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Solve Type. Options: Speed, Distance, Manipulation1, Manipulation2, Manipulation3";
          descriptor.read_only = false;
