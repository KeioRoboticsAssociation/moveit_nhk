...
bool dynamixel_controller__msg__dynamixel_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_controller.msg._dynamixel_response.DynamixelResponse", full_classname_dest, 62) == 0);
  }
  dynamixel_controller__msg__DynamixelResponse * ros_message = _ros_message;
  {  // command
...
{
  /* NOTE(esteve): Call constructor of DynamixelResponse */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_controller.msg._dynamixel_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DynamixelResponse");
