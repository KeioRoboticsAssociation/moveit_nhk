...
bool dynamixel_controller__msg__dynamixel_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_controller.msg._dynamixel_command.DynamixelCommand", full_classname_dest, 60) == 0);
  }
  dynamixel_controller__msg__DynamixelCommand * ros_message = _ros_message;
  {  // command
...
{
  /* NOTE(esteve): Call constructor of DynamixelCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_controller.msg._dynamixel_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DynamixelCommand");
