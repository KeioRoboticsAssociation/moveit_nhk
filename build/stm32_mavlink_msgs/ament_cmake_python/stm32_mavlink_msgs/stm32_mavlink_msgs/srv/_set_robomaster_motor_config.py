...
class SetRobomasterMotorConfig_Request(metaclass=Metaclass_SetRobomasterMotorConfig_Request):
    ...
    _fields_and_field_types = {
        'motor_id': 'uint8',
        'config': 'stm32_mavlink_msgs/RobomasterMotorConfig',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['stm32_mavlink_msgs', 'msg'], 'RobomasterMotorConfig'),  # noqa: E501
    )
...
class Metaclass_SetRobomasterMotorConfig(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'stm32_mavlink_msgs.srv.SetRobomasterMotorConfig')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from stm32_mavlink_msgs.srv import _set_robomaster_motor_config
...
class SetRobomasterMotorConfig(metaclass=Metaclass_SetRobomasterMotorConfig):
    from stm32_mavlink_msgs.srv._set_robomaster_motor_config import SetRobomasterMotorConfig_Request as Request
    from stm32_mavlink_msgs.srv._set_robomaster_motor_config import SetRobomasterMotorConfig_Response as Response
