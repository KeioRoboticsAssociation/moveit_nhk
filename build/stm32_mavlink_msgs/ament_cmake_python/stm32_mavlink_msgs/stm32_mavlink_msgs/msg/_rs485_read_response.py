...
class Metaclass_RS485ReadResponse(type):
    """Metaclass of message 'RS485ReadResponse'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'stm32_mavlink_msgs.msg.RS485ReadResponse')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__rs485_read_response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__rs485_read_response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__rs485_read_response
            cls._TYPE_SUPPORT = module.type_support_msg__msg__rs485_read_response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__rs485_read_response
...
class RS485ReadResponse(metaclass=Metaclass_RS485ReadResponse):
    """Message class 'RS485ReadResponse'."""
