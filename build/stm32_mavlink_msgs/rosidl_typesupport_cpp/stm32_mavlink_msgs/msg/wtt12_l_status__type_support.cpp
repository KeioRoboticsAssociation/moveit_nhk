...
static const _WTT12LStatus_type_support_symbol_names_t _WTT12LStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stm32_mavlink_msgs, msg, WTT12LStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, stm32_mavlink_msgs, msg, WTT12LStatus)),
  }
};
...
{
  return &::stm32_mavlink_msgs::msg::rosidl_typesupport_cpp::WTT12LStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, stm32_mavlink_msgs, msg, WTT12LStatus)() {
  return get_message_type_support_handle<stm32_mavlink_msgs::msg::WTT12LStatus>();
}
