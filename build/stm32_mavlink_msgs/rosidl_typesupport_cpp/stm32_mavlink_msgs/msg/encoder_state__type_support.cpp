...
static const _EncoderState_type_support_symbol_names_t _EncoderState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stm32_mavlink_msgs, msg, EncoderState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, stm32_mavlink_msgs, msg, EncoderState)),
  }
};
...
get_message_type_support_handle<stm32_mavlink_msgs::msg::EncoderState>()
{
  return &::stm32_mavlink_msgs::msg::rosidl_typesupport_cpp::EncoderState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, stm32_mavlink_msgs, msg, EncoderState)() {
  return get_message_type_support_handle<stm32_mavlink_msgs::msg::EncoderState>();
}
