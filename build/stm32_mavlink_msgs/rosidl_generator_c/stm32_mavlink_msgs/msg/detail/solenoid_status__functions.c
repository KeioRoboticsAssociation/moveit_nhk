...
stm32_mavlink_msgs__msg__SolenoidStatus__init(stm32_mavlink_msgs__msg__SolenoidStatus * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    stm32_mavlink_msgs__msg__SolenoidStatus__fini(msg);
    return false;
  }
  // solenoid_count
  // solenoid_states
...
stm32_mavlink_msgs__msg__SolenoidStatus__are_equal(const stm32_mavlink_msgs__msg__SolenoidStatus * lhs, const stm32_mavlink_msgs__msg__SolenoidStatus * rhs)
{
  ...
  // solenoid_count
  if (lhs->solenoid_count != rhs->solenoid_count) {
    return false;
  }
  // solenoid_states
  for (size_t i = 0; i < 8; ++i) {
    if (lhs->solenoid_states[i] != rhs->solenoid_states[i]) {
      return false;
    }
  }
  // timestamp_ms
  ...
  stm32_mavlink_msgs__msg__SolenoidStatus * output)
{
  ...
  // solenoid_count
  output->solenoid_count = input->solenoid_count;
  // solenoid_states
  for (size_t i = 0; i < 8; ++i) {
    output->solenoid_states[i] = input->solenoid_states[i];
  }
  // timestamp_ms
...
stm32_mavlink_msgs__msg__SolenoidStatus__create()
{
  ...
  stm32_mavlink_msgs__msg__SolenoidStatus * msg = (stm32_mavlink_msgs__msg__SolenoidStatus *)allocator.allocate(sizeof(stm32_mavlink_msgs__msg__SolenoidStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stm32_mavlink_msgs__msg__SolenoidStatus));
  bool success = stm32_mavlink_msgs__msg__SolenoidStatus__init(msg);
  if (!success) {
...
stm32_mavlink_msgs__msg__SolenoidStatus__Sequence__init(stm32_mavlink_msgs__msg__SolenoidStatus__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm32_mavlink_msgs__msg__SolenoidStatus * data = NULL;

  if (size) {
    data = (stm32_mavlink_msgs__msg__SolenoidStatus *)allocator.zero_allocate(size, sizeof(stm32_mavlink_msgs__msg__SolenoidStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stm32_mavlink_msgs__msg__SolenoidStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        stm32_mavlink_msgs__msg__SolenoidStatus__fini(&data[i - 1]);
      }
...
stm32_mavlink_msgs__msg__SolenoidStatus__Sequence__fini(stm32_mavlink_msgs__msg__SolenoidStatus__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      stm32_mavlink_msgs__msg__SolenoidStatus__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm32_mavlink_msgs__msg__SolenoidStatus__Sequence * array = (stm32_mavlink_msgs__msg__SolenoidStatus__Sequence *)allocator.allocate(sizeof(stm32_mavlink_msgs__msg__SolenoidStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stm32_mavlink_msgs__msg__SolenoidStatus__Sequence__init(array, size);
  if (!success) {
...
stm32_mavlink_msgs__msg__SolenoidStatus__Sequence__destroy(stm32_mavlink_msgs__msg__SolenoidStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stm32_mavlink_msgs__msg__SolenoidStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stm32_mavlink_msgs__msg__SolenoidStatus__Sequence__are_equal(const stm32_mavlink_msgs__msg__SolenoidStatus__Sequence * lhs, const stm32_mavlink_msgs__msg__SolenoidStatus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stm32_mavlink_msgs__msg__SolenoidStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stm32_mavlink_msgs__msg__SolenoidStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stm32_mavlink_msgs__msg__SolenoidStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stm32_mavlink_msgs__msg__SolenoidStatus * data =
      (stm32_mavlink_msgs__msg__SolenoidStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stm32_mavlink_msgs__msg__SolenoidStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stm32_mavlink_msgs__msg__SolenoidStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!stm32_mavlink_msgs__msg__SolenoidStatus__copy(
