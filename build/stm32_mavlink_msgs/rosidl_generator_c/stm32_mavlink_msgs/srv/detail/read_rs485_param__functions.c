...
stm32_mavlink_msgs__srv__ReadRS485Param_Request__create()
{
  ...
  stm32_mavlink_msgs__srv__ReadRS485Param_Request * msg = (stm32_mavlink_msgs__srv__ReadRS485Param_Request *)allocator.allocate(sizeof(stm32_mavlink_msgs__srv__ReadRS485Param_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stm32_mavlink_msgs__srv__ReadRS485Param_Request));
  bool success = stm32_mavlink_msgs__srv__ReadRS485Param_Request__init(msg);
  if (!success) {
...
stm32_mavlink_msgs__srv__ReadRS485Param_Request__destroy(stm32_mavlink_msgs__srv__ReadRS485Param_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    stm32_mavlink_msgs__srv__ReadRS485Param_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence__init(stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm32_mavlink_msgs__srv__ReadRS485Param_Request * data = NULL;

  if (size) {
    data = (stm32_mavlink_msgs__srv__ReadRS485Param_Request *)allocator.zero_allocate(size, sizeof(stm32_mavlink_msgs__srv__ReadRS485Param_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stm32_mavlink_msgs__srv__ReadRS485Param_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        stm32_mavlink_msgs__srv__ReadRS485Param_Request__fini(&data[i - 1]);
      }
...
stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence__fini(stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      stm32_mavlink_msgs__srv__ReadRS485Param_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence * array = (stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence *)allocator.allocate(sizeof(stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence__init(array, size);
  if (!success) {
...
stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence__destroy(stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence__are_equal(const stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence * lhs, const stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stm32_mavlink_msgs__srv__ReadRS485Param_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stm32_mavlink_msgs__srv__ReadRS485Param_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stm32_mavlink_msgs__srv__ReadRS485Param_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stm32_mavlink_msgs__srv__ReadRS485Param_Request * data =
      (stm32_mavlink_msgs__srv__ReadRS485Param_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stm32_mavlink_msgs__srv__ReadRS485Param_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stm32_mavlink_msgs__srv__ReadRS485Param_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!stm32_mavlink_msgs__srv__ReadRS485Param_Request__copy(
...
stm32_mavlink_msgs__srv__ReadRS485Param_Response__init(stm32_mavlink_msgs__srv__ReadRS485Param_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    stm32_mavlink_msgs__srv__ReadRS485Param_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm32_mavlink_msgs__srv__ReadRS485Param_Response * msg = (stm32_mavlink_msgs__srv__ReadRS485Param_Response *)allocator.allocate(sizeof(stm32_mavlink_msgs__srv__ReadRS485Param_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stm32_mavlink_msgs__srv__ReadRS485Param_Response));
  bool success = stm32_mavlink_msgs__srv__ReadRS485Param_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence__init(stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm32_mavlink_msgs__srv__ReadRS485Param_Response * data = NULL;

  if (size) {
    data = (stm32_mavlink_msgs__srv__ReadRS485Param_Response *)allocator.zero_allocate(size, sizeof(stm32_mavlink_msgs__srv__ReadRS485Param_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stm32_mavlink_msgs__srv__ReadRS485Param_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        stm32_mavlink_msgs__srv__ReadRS485Param_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence__fini(stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      stm32_mavlink_msgs__srv__ReadRS485Param_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence * array = (stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence *)allocator.allocate(sizeof(stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence__destroy(stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence__are_equal(const stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence * lhs, const stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stm32_mavlink_msgs__srv__ReadRS485Param_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stm32_mavlink_msgs__srv__ReadRS485Param_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stm32_mavlink_msgs__srv__ReadRS485Param_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stm32_mavlink_msgs__srv__ReadRS485Param_Response * data =
      (stm32_mavlink_msgs__srv__ReadRS485Param_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stm32_mavlink_msgs__srv__ReadRS485Param_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stm32_mavlink_msgs__srv__ReadRS485Param_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stm32_mavlink_msgs__srv__ReadRS485Param_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
