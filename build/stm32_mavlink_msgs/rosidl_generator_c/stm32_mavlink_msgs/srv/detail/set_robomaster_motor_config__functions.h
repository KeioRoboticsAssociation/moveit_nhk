...
#ifndef STM32_MAVLINK_MSGS__SRV__DETAIL__SET_ROBOMASTER_MOTOR_CONFIG__FUNCTIONS_H_
#define STM32_MAVLINK_MSGS__SRV__DETAIL__SET_ROBOMASTER_MOTOR_CONFIG__FUNCTIONS_H_
 ...
 * calls
 * stm32_mavlink_msgs__srv__SetRobomasterMotorConfig_Request__init().
...
/**
 * It calls
 * stm32_mavlink_msgs__srv__SetRobomasterMotorConfig_Request__fini()
 ...
 * stm32_mavlink_msgs__srv__SetRobomasterMotorConfig_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * stm32_mavlink_msgs__srv__SetRobomasterMotorConfig_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * stm32_mavlink_msgs__srv__SetRobomasterMotorConfig_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_stm32_mavlink_msgs
...
/**
 * It calls
 * stm32_mavlink_msgs__srv__SetRobomasterMotorConfig_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_stm32_mavlink_msgs
...
/**
 * It allocates the memory for the array and calls
 * stm32_mavlink_msgs__srv__SetRobomasterMotorConfig_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_stm32_mavlink_msgs
...
/**
 * It calls
 * stm32_mavlink_msgs__srv__SetRobomasterMotorConfig_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // STM32_MAVLINK_MSGS__SRV__DETAIL__SET_ROBOMASTER_MOTOR_CONFIG__FUNCTIONS_H_
