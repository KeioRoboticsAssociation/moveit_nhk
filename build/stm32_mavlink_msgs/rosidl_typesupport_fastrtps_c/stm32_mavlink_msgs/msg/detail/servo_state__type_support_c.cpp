...
#include "stm32_mavlink_msgs/msg/detail/servo_state__rosidl_typesupport_fastrtps_c.h"
...
using _ServoState__ros_msg_type = stm32_mavlink_msgs__msg__ServoState;
...
size_t get_serialized_size_stm32_mavlink_msgs__msg__ServoState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ServoState__ros_msg_type * ros_message = static_cast<const _ServoState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ServoState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_stm32_mavlink_msgs__msg__ServoState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stm32_mavlink_msgs
size_t max_serialized_size_stm32_mavlink_msgs__msg__ServoState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_mavlink_msgs__msg__ServoState;
    is_plain =
      (
...
static size_t _ServoState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stm32_mavlink_msgs__msg__ServoState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stm32_mavlink_msgs, msg, ServoState)() {
