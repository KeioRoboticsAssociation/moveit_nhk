...
#include "stm32_mavlink_msgs/msg/detail/rs485_motor_state__rosidl_typesupport_fastrtps_c.h"
...
using _RS485MotorState__ros_msg_type = stm32_mavlink_msgs__msg__RS485MotorState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RS485MotorState__ros_msg_type * ros_message = static_cast<const _RS485MotorState__ros_msg_type *>(untyped_ros_message);
  // Field name: motor_id
  {
  ...
  // Field name: current_position_rotations
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RS485MotorState__ros_msg_type * ros_message = static_cast<_RS485MotorState__ros_msg_type *>(untyped_ros_message);
  // Field name: motor_id
  {
    cdr >> ros_message->motor_id;
  }
...
size_t get_serialized_size_stm32_mavlink_msgs__msg__RS485MotorState(
  const void * untyped_ros_message,
...
static uint32_t _RS485MotorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_stm32_mavlink_msgs__msg__RS485MotorState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stm32_mavlink_msgs
size_t max_serialized_size_stm32_mavlink_msgs__msg__RS485MotorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_mavlink_msgs__msg__RS485MotorState;
    is_plain =
      (
...
static size_t _RS485MotorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stm32_mavlink_msgs__msg__RS485MotorState(
...
static message_type_support_callbacks_t __callbacks_RS485MotorState = {
...
static rosidl_message_type_support_t _RS485MotorState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RS485MotorState,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stm32_mavlink_msgs, msg, RS485MotorState)() {
  return &_RS485MotorState__type_support;
}
