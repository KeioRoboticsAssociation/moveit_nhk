...
#include "stm32_mavlink_msgs/msg/detail/encoder_state__rosidl_typesupport_fastrtps_c.h"
...
using _EncoderState__ros_msg_type = stm32_mavlink_msgs__msg__EncoderState;
...
size_t get_serialized_size_stm32_mavlink_msgs__msg__EncoderState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EncoderState__ros_msg_type * ros_message = static_cast<const _EncoderState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _EncoderState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_stm32_mavlink_msgs__msg__EncoderState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stm32_mavlink_msgs
size_t max_serialized_size_stm32_mavlink_msgs__msg__EncoderState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_mavlink_msgs__msg__EncoderState;
    is_plain =
      (
...
static size_t _EncoderState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stm32_mavlink_msgs__msg__EncoderState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stm32_mavlink_msgs, msg, EncoderState)() {
