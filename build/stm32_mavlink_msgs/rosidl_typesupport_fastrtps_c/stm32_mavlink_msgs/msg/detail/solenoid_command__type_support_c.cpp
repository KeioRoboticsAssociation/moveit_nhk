...
#include "stm32_mavlink_msgs/msg/detail/solenoid_command__rosidl_typesupport_fastrtps_c.h"
...
using _SolenoidCommand__ros_msg_type = stm32_mavlink_msgs__msg__SolenoidCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: solenoid_id
  {
    cdr << ros_message->solenoid_id;
  }
...
size_t get_serialized_size_stm32_mavlink_msgs__msg__SolenoidCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name solenoid_id
  {
    size_t item_size = sizeof(ros_message->solenoid_id);
...
static uint32_t _SolenoidCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_stm32_mavlink_msgs__msg__SolenoidCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stm32_mavlink_msgs
size_t max_serialized_size_stm32_mavlink_msgs__msg__SolenoidCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_mavlink_msgs__msg__SolenoidCommand;
    is_plain =
      (
...
static size_t _SolenoidCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stm32_mavlink_msgs__msg__SolenoidCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stm32_mavlink_msgs, msg, SolenoidCommand)() {
