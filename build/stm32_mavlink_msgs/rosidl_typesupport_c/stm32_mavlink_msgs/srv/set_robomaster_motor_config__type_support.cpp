...
static const _SetRobomasterMotorConfig_Request_type_support_symbol_names_t _SetRobomasterMotorConfig_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stm32_mavlink_msgs, srv, SetRobomasterMotorConfig_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, stm32_mavlink_msgs, srv, SetRobomasterMotorConfig_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, stm32_mavlink_msgs, srv, SetRobomasterMotorConfig_Request)() {
  return &::stm32_mavlink_msgs::srv::rosidl_typesupport_c::SetRobomasterMotorConfig_Request_message_type_support_handle;
}
...
static const _SetRobomasterMotorConfig_Response_type_support_symbol_names_t _SetRobomasterMotorConfig_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stm32_mavlink_msgs, srv, SetRobomasterMotorConfig_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, stm32_mavlink_msgs, srv, SetRobomasterMotorConfig_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, stm32_mavlink_msgs, srv, SetRobomasterMotorConfig_Response)() {
  return &::stm32_mavlink_msgs::srv::rosidl_typesupport_c::SetRobomasterMotorConfig_Response_message_type_support_handle;
}
...
static const _SetRobomasterMotorConfig_type_support_symbol_names_t _SetRobomasterMotorConfig_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stm32_mavlink_msgs, srv, SetRobomasterMotorConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, stm32_mavlink_msgs, srv, SetRobomasterMotorConfig)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, stm32_mavlink_msgs, srv, SetRobomasterMotorConfig)() {
  return &::stm32_mavlink_msgs::srv::rosidl_typesupport_c::SetRobomasterMotorConfig_service_type_support_handle;
}
