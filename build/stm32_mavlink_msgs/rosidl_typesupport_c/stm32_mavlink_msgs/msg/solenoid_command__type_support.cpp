...
static const _SolenoidCommand_type_support_symbol_names_t _SolenoidCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stm32_mavlink_msgs, msg, SolenoidCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, stm32_mavlink_msgs, msg, SolenoidCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, stm32_mavlink_msgs, msg, SolenoidCommand)() {
  return &::stm32_mavlink_msgs::msg::rosidl_typesupport_c::SolenoidCommand_message_type_support_handle;
}
