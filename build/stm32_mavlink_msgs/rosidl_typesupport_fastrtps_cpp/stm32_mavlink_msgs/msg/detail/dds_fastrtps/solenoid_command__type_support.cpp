...
#include "stm32_mavlink_msgs/msg/detail/solenoid_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const stm32_mavlink_msgs::msg::SolenoidCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stm32_mavlink_msgs::msg::SolenoidCommand & ros_message)
{
  // Member: solenoid_id
  cdr >> ros_message.solenoid_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_mavlink_msgs::msg::SolenoidCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stm32_mavlink_msgs::msg::SolenoidCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stm32_mavlink_msgs::msg::SolenoidCommand *>(
    untyped_ros_message);
...
{
  return &stm32_mavlink_msgs::msg::typesupport_fastrtps_cpp::_SolenoidCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stm32_mavlink_msgs, msg, SolenoidCommand)() {
  return &stm32_mavlink_msgs::msg::typesupport_fastrtps_cpp::_SolenoidCommand__handle;
}
