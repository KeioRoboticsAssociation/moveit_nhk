...
#include "stm32_mavlink_msgs/msg/detail/robomaster_motor_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const stm32_mavlink_msgs::msg::RobomasterMotorState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stm32_mavlink_msgs::msg::RobomasterMotorState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_mavlink_msgs::msg::RobomasterMotorState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stm32_mavlink_msgs::msg::RobomasterMotorState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stm32_mavlink_msgs::msg::RobomasterMotorState *>(
    untyped_ros_message);
...
get_message_type_support_handle<stm32_mavlink_msgs::msg::RobomasterMotorState>()
{
  return &stm32_mavlink_msgs::msg::typesupport_fastrtps_cpp::_RobomasterMotorState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stm32_mavlink_msgs, msg, RobomasterMotorState)() {
  return &stm32_mavlink_msgs::msg::typesupport_fastrtps_cpp::_RobomasterMotorState__handle;
}
