...
#include "stm32_mavlink_msgs/msg/detail/encoder_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_mavlink_msgs::msg::EncoderState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stm32_mavlink_msgs::msg::EncoderState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stm32_mavlink_msgs::msg::EncoderState *>(
    untyped_ros_message);
...
{
  return &stm32_mavlink_msgs::msg::typesupport_fastrtps_cpp::_EncoderState__handle;
}
