...
#include "stm32_mavlink_msgs/msg/detail/servo_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const stm32_mavlink_msgs::msg::ServoCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stm32_mavlink_msgs::msg::ServoCommand & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_mavlink_msgs::msg::ServoCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stm32_mavlink_msgs::msg::ServoCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stm32_mavlink_msgs::msg::ServoCommand *>(
    untyped_ros_message);
...
{
  return &stm32_mavlink_msgs::msg::typesupport_fastrtps_cpp::_ServoCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stm32_mavlink_msgs, msg, ServoCommand)() {
  return &stm32_mavlink_msgs::msg::typesupport_fastrtps_cpp::_ServoCommand__handle;
}
