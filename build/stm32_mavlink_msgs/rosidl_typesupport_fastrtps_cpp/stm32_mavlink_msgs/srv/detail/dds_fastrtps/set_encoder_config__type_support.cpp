...
#include "stm32_mavlink_msgs/srv/detail/set_encoder_config__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const stm32_mavlink_msgs::srv::SetEncoderConfig_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stm32_mavlink_msgs::srv::SetEncoderConfig_Request & ros_message)
{
  // Member: encoder_id
  cdr >> ros_message.encoder_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_mavlink_msgs::srv::SetEncoderConfig_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stm32_mavlink_msgs::srv::SetEncoderConfig_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stm32_mavlink_msgs::srv::SetEncoderConfig_Request *>(
    untyped_ros_message);
...
{
  return &stm32_mavlink_msgs::srv::typesupport_fastrtps_cpp::_SetEncoderConfig_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stm32_mavlink_msgs, srv, SetEncoderConfig_Request)() {
  return &stm32_mavlink_msgs::srv::typesupport_fastrtps_cpp::_SetEncoderConfig_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_stm32_mavlink_msgs
cdr_serialize(
  const stm32_mavlink_msgs::srv::SetEncoderConfig_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stm32_mavlink_msgs::srv::SetEncoderConfig_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stm32_mavlink_msgs::srv::SetEncoderConfig_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stm32_mavlink_msgs::srv::SetEncoderConfig_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<stm32_mavlink_msgs::srv::SetEncoderConfig_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &stm32_mavlink_msgs::srv::typesupport_fastrtps_cpp::_SetEncoderConfig_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stm32_mavlink_msgs, srv, SetEncoderConfig_Response)() {
  return &stm32_mavlink_msgs::srv::typesupport_fastrtps_cpp::_SetEncoderConfig_Response__handle;
}
...
{
  return &stm32_mavlink_msgs::srv::typesupport_fastrtps_cpp::_SetEncoderConfig__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stm32_mavlink_msgs, srv, SetEncoderConfig)() {
  return &stm32_mavlink_msgs::srv::typesupport_fastrtps_cpp::_SetEncoderConfig__handle;
}
